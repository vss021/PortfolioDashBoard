...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "http://localhost:4000https://portfolio-backend-wptf.onrender.com/api/v1/timeline/getall",
...
export const addNewTimeline = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "http://localhost:4000https://portfolio-backend-wptf.onrender.com/api/v1/timeline/add",
      data,
      {
        withCredentials: true,
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `http://localhost:4000https://portfolio-backend-wptf.onrender.com/api/v1/timeline/delete/${id}`,
      {
        withCredentials: true,
      }
    );
